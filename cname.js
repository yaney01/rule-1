...
async function operator(proxies) {
  ...
  if (typeof scriptResourceCache === 'undefined') {
    ...
    if (target=="Surge"){
      ...
      $notification.post("NCNAME Sub-Store未更新", "", "请点击安装插件, 或查看Log安装对应版本, 并关闭原本的Substore", "https://www.nsloon.com/openloon/import?plugin=https://gitlab.com/lodepuly/vpn_tool/-/raw/main/Tool/Loon/Plugin/Sub-Store.plugin")
    return proxies;
  }
  // 批处理个数
