  ...
  try {
    ...
    if (isPanel) {
      ...
      result = {
        ...
        <h3>MitM<small>${hostnameNUM} ${mitm ? "✅" : "❌ "}</small></h3>
        <h3>Script<small>${ScriptNUM} ${scripting ? "✅" : "❌ "}</small></h3>
        <h3>Rewrite<small>${RewriteNUM} ${rewrite ? "✅" : "❌ "}</small></h3>
        <h3>Hostname</h3>
