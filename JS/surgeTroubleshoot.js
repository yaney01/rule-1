    ...
    if (isPanel) {
      ...
      result = {
        ...
        <h3 style="margin-bottom: -4px; padding-top:6px;">Rule: ${ALL_NUM}</h3><pre><code>${Object.entries(
            ...
            ${
              Object.entries(RULELIST).length > 0
                ? `
          <h3 style="margin-bottom: -4px; padding-top:6px;">Rule List</h3><pre><code>${Object.entries(
            ...
            .map(([k, v]) =>
              v !== 0
                ? `<a style="text-decoration:none;" target="_blank" href="${RULELIST_URL[k]}">${k}: ${v}\n</a>`
                : ""
            )
            .join("")}</code></pre>`
                : ""
