// https://raw.githubusercontent.com/xream/scripts/main/surge/modules/troubleshoot/troubleshoot.js
...
!(async () => {
  try {
    ...
    const AllRule = scRule.concat(ruleSetRaw.split("\n"));
    AllRule.forEach((e) => {
      ALL_NUM++;
    ...
    const AROBJ = {
      ...
      DOMAIN_SET_RAW: DOMAIN_SET_RAW,
    };
    Object.entries(AROBJ).forEach(([key, value]) => {
      if (value != 0) {
    ...
    result = {
      response: {
        ...
        <h3>Rewrite <small>${
          ...
          .join(
            ""
          )}</code></pre><fƒooter>Made With &hearts; By <a href="https://t.me/zhetengsha">@xream</a></footer></body></html>`,
      },
    };
  } catch (e) {
    console.log(e);
