    ...
    result = {
      response: {
        ...
        <h3 style="margin-bottom: -4px; padding-top:6px;">Rule(${ALL_NUM})</h3><pre><code>${Object.entries(
          ...
          .map(([k, v]) => (v !== 0 ? `<i>${k}: ${v}\n</i>` : ""))
          .join("")}</code></pre>
          <tƒooter style="text-align:center;padding:20px;">Made With &hearts; By <a  style="text-decoration:none;" href="https://t.me/zhetengsha">@xream @key</a></footer></body></html>`,
      },
    };
  } catch (e) {
    console.log(e.message);
