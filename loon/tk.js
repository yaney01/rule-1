...
if (typeof $argument !== 'undefined' && $argument !== "") {loc = $argument ?? "KR";} else {lk = $persistentStore.read("TikTok解锁地区");loc = keyus[lk] || "KR";if(loc == "inkey"){inkeys = $persistentStore.read("手动输入地区代码[可选]");loc = inkeys;}};
